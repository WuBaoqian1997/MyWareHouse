...
<body>
	<div id="m_jiao_main">
		...
		<div class="fn-clear">
			<div class="fn-left">
			<form action="refund.action" method="post" id="savemoneys">
				<div id="advancePayForm" class="validationEngineContainer">
					<div i="title" class="art-ui-dialog-title" id="title:1500735064451">退款</div>
					<ul class="form-inline">
						<li class="mb10"><label class="w60 mr5 text-right"> <i
								class="q-icon color-danger">*</i>退款房号 </label>
						 <select
						...
						<li class="mb10"><label class="w60 mr5 text-right"> <i
								class="q-icon color-danger">*</i>退款方式 </label> 
								<select class="form-control input-sm w200">
						...
						<li class="mb10"><label class="w60 mr5 text-right"> <i
								class="q-icon color-danger">*</i>退款金额 </label> <!--ms-if--> <input
							class="validate[required,custom[minusMoney]] form-control
                              input-sm w200"
							maxlength="9" data-errormessage-value-missing="请填写支付金额" 
							data-errormessage-custom-error="请正确填写支付金额" value="-${(orders.customer.deposit)- (orders.customer.accountsPayable)}" type="text">
						</li>
						<!-- 订单编号 -->
						...
						<div style="width:100%">
							<div class="g-f-btn j-btn-w" style="padding-left: 200px;">
								<input type="button" id="savemoney" class="btn btn-success btn-sm  mr10"
									style="display: inline-block;"  value="退款">
							</div>
						</div>
					</ul>
				</div>
